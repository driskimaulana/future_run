...
public class GameMenu extends JPanel implements ActionListener {
    ...
    public GameMenu()
    {
        ...
        labelTitle.setFont(new Font("Purisa", Font.BOLD, 32));
        ...
        try {
            ...
            System.out.println(texperiences.getSize());
        ...
        labelUsername.setFont(new Font("Purisa", Font.BOLD, 16));
        ...
        // buttonPanel.setLayout(new GridBagConstraints());
